...
class FirstCVElementPainter extends CustomPainter {
  FirstCVElementPainter(this.image, this.animationValue, this.color);
  ...
  void paintShadow(Canvas canvas, Size size) {
  ...
  @override
  bool shouldRepaint(FirstCVElementPainter oldDelegate) => true;

  @override
  bool shouldRebuildSemantics(FirstCVElementPainter oldDelegate) => false;
}
